    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseLevelDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseLevel.detail.title">CourseLevel</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="charuVidyaApp.courseLevel.id">Id</Translate>
            </span>
          </dt>
          <dd>{courseLevelEntity.id}</dd>
          <dt>
            <span id="title">
              <Translate contentKey="charuVidyaApp.courseLevel.title">Title</Translate>
            </span>
          </dt>
          <dd>{courseLevelEntity.title}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="charuVidyaApp.courseLevel.description">Description</Translate>
            </span>
          </dt>
