...
/**
 * Criteria class for the {@link in.codersage.charuvidya.domain.CourseSessionProgress} entity. This class is used
 * in {@link in.codersage.charuvidya.web.rest.CourseSessionProgressResource} to receive all the possible filtering options from
