...
export const CourseCategoryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseCategory.delete.question">
        <Translate contentKey="charuVidyaApp.courseCategory.delete.question" interpolate={{ id: courseCategoryEntity.id }}>
