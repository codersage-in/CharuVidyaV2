  ...
  return (
    <div>
      <h2 id="course-heading" data-cy="CourseHeading">
        <Translate contentKey="charuVidyaApp.course.home.title">Courses</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="charuVidyaApp.course.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="charuVidyaApp.course.home.createLabel">Create new Course</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseList && courseList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="charuVidyaApp.course.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('courseTitle')}>
                  <Translate contentKey="charuVidyaApp.course.courseTitle">Course Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('courseSubTitle')}>
                  <Translate contentKey="charuVidyaApp.course.courseSubTitle">Course Sub Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('courseLength')}>
                  <Translate contentKey="charuVidyaApp.course.courseLength">Course Length</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('courseLogo')}>
                  <Translate contentKey="charuVidyaApp.course.courseLogo">Course Logo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('courseCreatedOn')}>
                  <Translate contentKey="charuVidyaApp.course.courseCreatedOn">Course Created On</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('courseUpdatedOn')}>
                  <Translate contentKey="charuVidyaApp.course.courseUpdatedOn">Course Updated On</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('courseRootDir')}>
                  <Translate contentKey="charuVidyaApp.course.courseRootDir">Course Root Dir</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('amount')}>
                  <Translate contentKey="charuVidyaApp.course.amount">Amount</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isDraft')}>
                  <Translate contentKey="charuVidyaApp.course.isDraft">Is Draft</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isApproved')}>
                  <Translate contentKey="charuVidyaApp.course.isApproved">Is Approved</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isPublished')}>
                  <Translate contentKey="charuVidyaApp.course.isPublished">Is Published</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="charuVidyaApp.course.courseLevel">Course Level</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="charuVidyaApp.course.courseCategory">Course Category</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="charuVidyaApp.course.courseType">Course Type</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="charuVidyaApp.course.user">User</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="charuVidyaApp.course.reviewer">Reviewer</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="charuVidyaApp.course.home.notFound">No Courses found</Translate>
            </div>
          )
        )}
      </div>
