  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseAssignmentProgress.home.createOrEditLabel" data-cy="CourseAssignmentProgressCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseAssignmentProgress.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignmentProgress.completed')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignmentProgress.completedDate')}
