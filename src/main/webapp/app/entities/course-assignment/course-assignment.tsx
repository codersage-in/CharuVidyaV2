  ...
  return (
    <div>
      <h2 id="course-assignment-heading" data-cy="CourseAssignmentHeading">
        <Translate contentKey="charuVidyaApp.courseAssignment.home.title">Course Assignments</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="charuVidyaApp.courseAssignment.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="charuVidyaApp.courseAssignment.home.createLabel">Create new Course Assignment</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseAssignmentList && courseAssignmentList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('isPreview')}>
                  <Translate contentKey="charuVidyaApp.courseAssignment.isPreview">Is Preview</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isDraft')}>
                  <Translate contentKey="charuVidyaApp.courseAssignment.isDraft">Is Draft</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isApproved')}>
                  <Translate contentKey="charuVidyaApp.courseAssignment.isApproved">Is Approved</Translate> <FontAwesomeIcon icon="sort" />
                </th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="charuVidyaApp.courseAssignment.home.notFound">No Course Assignments found</Translate>
            </div>
          )
        )}
      </div>
