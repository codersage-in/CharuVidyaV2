    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseTypeDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseType.detail.title">CourseType</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="charuVidyaApp.courseType.id">Id</Translate>
            </span>
          </dt>
          <dd>{courseTypeEntity.id}</dd>
          <dt>
            <span id="title">
              <Translate contentKey="charuVidyaApp.courseType.title">Title</Translate>
            </span>
          </dt>
          <dd>{courseTypeEntity.title}</dd>
          <dt>
            <span id="description">
              <Translate contentKey="charuVidyaApp.courseType.description">Description</Translate>
            </span>
          </dt>
