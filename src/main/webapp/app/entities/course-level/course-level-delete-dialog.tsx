...
export const CourseLevelDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseLevel.delete.question">
        <Translate contentKey="charuVidyaApp.courseLevel.delete.question" interpolate={{ id: courseLevelEntity.id }}>
