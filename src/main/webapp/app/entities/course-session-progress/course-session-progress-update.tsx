  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseSessionProgress.home.createOrEditLabel" data-cy="CourseSessionProgressCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseSessionProgress.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseSessionProgress.watchSeconds')}
