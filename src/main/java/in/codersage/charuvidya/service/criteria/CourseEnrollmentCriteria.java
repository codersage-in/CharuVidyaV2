...
/**
 * Criteria class for the {@link in.codersage.charuvidya.domain.CourseEnrollment} entity. This class is used
 * in {@link in.codersage.charuvidya.web.rest.CourseEnrollmentResource} to receive all the possible filtering options from
