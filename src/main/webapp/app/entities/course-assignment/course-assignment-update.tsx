  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseAssignment.home.createOrEditLabel" data-cy="CourseAssignmentCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseAssignment.home.createOrEditLabel">Create or edit a CourseAssignment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  label={translate('charuVidyaApp.courseAssignment.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.assignmentTitle')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.assignmentDescription')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.sessionVideo')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.sessionDuration')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.assignmentOrder')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.assignmentResource')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.isPreview')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.isDraft')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.isApproved')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignment.isPublished')}
              ...
              <ValidatedField
                ...
                label={translate('charuVidyaApp.courseAssignment.courseSection')}
                type="select"
              >
                <option value="" key="0" />
                {courseSections
