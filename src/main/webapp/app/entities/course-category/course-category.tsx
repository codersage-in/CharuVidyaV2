  ...
  return (
    <div>
      <h2 id="course-category-heading" data-cy="CourseCategoryHeading">
        <Translate contentKey="charuVidyaApp.courseCategory.home.title">Course Categories</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="charuVidyaApp.courseCategory.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="charuVidyaApp.courseCategory.home.createLabel">Create new Course Category</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseCategoryList && courseCategoryList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="charuVidyaApp.courseCategory.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('title')}>
                  <Translate contentKey="charuVidyaApp.courseCategory.title">Title</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('logo')}>
                  <Translate contentKey="charuVidyaApp.courseCategory.logo">Logo</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isParent')}>
                  <Translate contentKey="charuVidyaApp.courseCategory.isParent">Is Parent</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('parentId')}>
                  <Translate contentKey="charuVidyaApp.courseCategory.parentId">Parent Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('description')}>
                  <Translate contentKey="charuVidyaApp.courseCategory.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="charuVidyaApp.courseCategory.home.notFound">No Course Categories found</Translate>
            </div>
          )
        )}
      </div>
