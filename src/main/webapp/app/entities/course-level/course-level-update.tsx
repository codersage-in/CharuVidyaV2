  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseLevel.home.createOrEditLabel" data-cy="CourseLevelCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseLevel.home.createOrEditLabel">Create or edit a CourseLevel</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseLevel.title')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseLevel.description')}
