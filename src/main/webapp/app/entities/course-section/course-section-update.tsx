  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseSection.home.createOrEditLabel" data-cy="CourseSectionCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseSection.home.createOrEditLabel">Create or edit a CourseSection</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseSection.sectionTitle')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseSection.sectionDescription')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseSection.sectionOrder')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseSection.isDraft')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseSection.isApproved')}
