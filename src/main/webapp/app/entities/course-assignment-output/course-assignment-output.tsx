  ...
  return (
    <div>
      <h2 id="course-assignment-output-heading" data-cy="CourseAssignmentOutputHeading">
        <Translate contentKey="charuVidyaApp.courseAssignmentOutput.home.title">Course Assignment Outputs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="charuVidyaApp.courseAssignmentOutput.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="charuVidyaApp.courseAssignmentOutput.home.createLabel">Create new Course Assignment Output</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseAssignmentOutputList && courseAssignmentOutputList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="charuVidyaApp.courseAssignmentOutput.id">Id</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('output')}>
                  <Translate contentKey="charuVidyaApp.courseAssignmentOutput.output">Output</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
                  <Translate contentKey="charuVidyaApp.courseAssignmentOutput.courseAssignment">Course Assignment</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="charuVidyaApp.courseAssignmentOutput.home.notFound">No Course Assignment Outputs found</Translate>
            </div>
          )
        )}
      </div>
