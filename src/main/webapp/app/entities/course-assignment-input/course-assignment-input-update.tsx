  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseAssignmentInput.home.createOrEditLabel" data-cy="CourseAssignmentInputCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseAssignmentInput.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignmentInput.input')}
