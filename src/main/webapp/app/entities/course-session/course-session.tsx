  ...
  return (
    <div>
      <h2 id="course-session-heading" data-cy="CourseSessionHeading">
        <Translate contentKey="charuVidyaApp.courseSession.home.title">Course Sessions</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="charuVidyaApp.courseSession.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="charuVidyaApp.courseSession.home.createLabel">Create new Course Session</Translate>
          </Link>
        </div>
      </h2>
        ...
        {courseSessionList && courseSessionList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('sessionVideo')}>
                  <Translate contentKey="charuVidyaApp.courseSession.sessionVideo">Session Video</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('sessionOrder')}>
                  <Translate contentKey="charuVidyaApp.courseSession.sessionOrder">Session Order</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th className="hand" onClick={sort('isDraft')}>
                  <Translate contentKey="charuVidyaApp.courseSession.isDraft">Is Draft</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isApproved')}>
                  <Translate contentKey="charuVidyaApp.courseSession.isApproved">Is Approved</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('isPublished')}>
                  <Translate contentKey="charuVidyaApp.courseSession.isPublished">Is Published</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="charuVidyaApp.courseSession.home.notFound">No Course Sessions found</Translate>
            </div>
          )
        )}
      </div>
