    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseSessionProgressDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseSessionProgress.detail.title">CourseSessionProgress</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="charuVidyaApp.courseSessionProgress.id">Id</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="charuVidyaApp.courseSessionProgress.user">User</Translate>
          </dt>
