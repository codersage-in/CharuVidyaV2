    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseAssignmentOutputDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseAssignmentOutput.detail.title">CourseAssignmentOutput</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="charuVidyaApp.courseAssignmentOutput.id">Id</Translate>
            </span>
          </dt>
          <dd>{courseAssignmentOutputEntity.id}</dd>
          <dt>
            <span id="output">
              <Translate contentKey="charuVidyaApp.courseAssignmentOutput.output">Output</Translate>
            </span>
          </dt>
