...
export const CourseSessionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseSession.delete.question">
        <Translate contentKey="charuVidyaApp.courseSession.delete.question" interpolate={{ id: courseSessionEntity.id }}>
