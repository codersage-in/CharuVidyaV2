    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseAssignmentInputDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseAssignmentInput.detail.title">CourseAssignmentInput</Translate>
        </h2>
        <dl className="jh-entity-details">
          <dt>
            <span id="id">
              <Translate contentKey="charuVidyaApp.courseAssignmentInput.id">Id</Translate>
            </span>
          </dt>
          <dd>{courseAssignmentInputEntity.id}</dd>
          <dt>
            <span id="input">
              <Translate contentKey="charuVidyaApp.courseAssignmentInput.input">Input</Translate>
            </span>
          </dt>
          ...
          <dt>
            <Translate contentKey="charuVidyaApp.courseAssignmentInput.user">User</Translate>
          </dt>
