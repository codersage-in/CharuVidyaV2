  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseReviewStatus.home.createOrEditLabel" data-cy="CourseReviewStatusCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseReviewStatus.home.createOrEditLabel">Create or edit a CourseReviewStatus</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseReviewStatus.status')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseReviewStatus.feedback')}
