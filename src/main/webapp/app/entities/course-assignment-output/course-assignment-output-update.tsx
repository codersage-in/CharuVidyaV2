  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseAssignmentOutput.home.createOrEditLabel" data-cy="CourseAssignmentOutputCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseAssignmentOutput.home.createOrEditLabel">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseAssignmentOutput.output')}
