...
/**
 * Criteria class for the {@link in.codersage.charuvidya.domain.CourseSession} entity. This class is used
 * in {@link in.codersage.charuvidya.web.rest.CourseSessionResource} to receive all the possible filtering options from
