...
export const CourseSessionProgressDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseSessionProgress.delete.question">
        <Translate contentKey="charuVidyaApp.courseSessionProgress.delete.question" interpolate={{ id: courseSessionProgressEntity.id }}>
