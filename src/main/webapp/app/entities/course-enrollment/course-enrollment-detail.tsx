    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseEnrollmentDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseEnrollment.detail.title">CourseEnrollment</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <Translate contentKey="charuVidyaApp.courseEnrollment.user">User</Translate>
          </dt>
