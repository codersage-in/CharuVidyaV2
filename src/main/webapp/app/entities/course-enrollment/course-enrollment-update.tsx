  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseEnrollment.home.createOrEditLabel" data-cy="CourseEnrollmentCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseEnrollment.home.createOrEditLabel">Create or edit a CourseEnrollment</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('charuVidyaApp.courseEnrollment.enrollementDate')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseEnrollment.lastAccessedDate')}
