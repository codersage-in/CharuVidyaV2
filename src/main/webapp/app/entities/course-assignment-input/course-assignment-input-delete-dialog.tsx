...
export const CourseAssignmentInputDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseAssignmentInput.delete.question">
        <Translate contentKey="charuVidyaApp.courseAssignmentInput.delete.question" interpolate={{ id: courseAssignmentInputEntity.id }}>
