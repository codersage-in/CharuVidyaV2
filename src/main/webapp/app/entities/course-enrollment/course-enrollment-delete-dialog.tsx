...
export const CourseEnrollmentDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseEnrollment.delete.question">
        <Translate contentKey="charuVidyaApp.courseEnrollment.delete.question" interpolate={{ id: courseEnrollmentEntity.id }}>
