  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="charuVidyaApp.courseCategory.home.createOrEditLabel" data-cy="CourseCategoryCreateUpdateHeading">
            <Translate contentKey="charuVidyaApp.courseCategory.home.createOrEditLabel">Create or edit a CourseCategory</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              {!isNew ? (
                <ValidatedField
                  ...
                  label={translate('charuVidyaApp.courseCategory.id')}
                  validate={{ required: true }}
                />
              ) : null}
              <ValidatedField
                label={translate('charuVidyaApp.courseCategory.title')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseCategory.logo')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseCategory.isParent')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseCategory.parentId')}
              ...
              />
              <ValidatedField
                label={translate('charuVidyaApp.courseCategory.description')}
