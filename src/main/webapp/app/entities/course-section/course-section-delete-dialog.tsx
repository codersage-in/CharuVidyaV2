...
export const CourseSectionDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="charuVidyaApp.courseSection.delete.question">
        <Translate contentKey="charuVidyaApp.courseSection.delete.question" interpolate={{ id: courseSectionEntity.id }}>
