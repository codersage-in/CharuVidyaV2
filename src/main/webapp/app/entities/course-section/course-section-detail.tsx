    ...
    <Row>
      <Col md="8">
        <h2 data-cy="courseSectionDetailsHeading">
          <Translate contentKey="charuVidyaApp.courseSection.detail.title">CourseSection</Translate>
        </h2>
        <dl className="jh-entity-details">
          ...
          <dt>
            <span id="sectionTitle">
              <Translate contentKey="charuVidyaApp.courseSection.sectionTitle">Section Title</Translate>
            </span>
          </dt>
          ...
          <dt>
            <span id="sectionOrder">
              <Translate contentKey="charuVidyaApp.courseSection.sectionOrder">Section Order</Translate>
            </span>
          </dt>
          <dd>{courseSectionEntity.sectionOrder}</dd>
          <dt>
            <span id="isDraft">
              <Translate contentKey="charuVidyaApp.courseSection.isDraft">Is Draft</Translate>
            </span>
          </dt>
          <dd>{courseSectionEntity.isDraft ? 'true' : 'false'}</dd>
          <dt>
            <span id="isApproved">
              <Translate contentKey="charuVidyaApp.courseSection.isApproved">Is Approved</Translate>
            </span>
          </dt>
          <dd>{courseSectionEntity.isApproved ? 'true' : 'false'}</dd>
          <dt>
            <Translate contentKey="charuVidyaApp.courseSection.course">Course</Translate>
          </dt>
