...
/**
 * Criteria class for the {@link in.codersage.charuvidya.domain.CourseAssignment} entity. This class is used
 * in {@link in.codersage.charuvidya.web.rest.CourseAssignmentResource} to receive all the possible filtering options from
